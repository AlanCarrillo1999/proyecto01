...
<head>
    ...
    <title>Pink ink - tatto studio</title>
                    ...
                    <div class="nav-inner">
                        ...
                        <nav class="navbar navbar-expand-lg">
                            <a class="navbar-brand" href="index.html">
                                <img src="assets/images/logo/pink-ink.jpg" alt="Logo">
                            </a>
            ...
            <div class="row align-items-center">
                <div class="col-lg-5 col-md-12 col-12">
                    <div class="hero-content">
                        <h1 class="wow fadeInLeft" data-wow-delay=".4s">estudio de tatuaje con mas de 6 años de experiencia</h1>
                        <p class="wow fadeInLeft" data-wow-delay=".6s"> para contactar igresa a contacto y en breve nos comunicaremos contigo
                ...
                <div class="col-lg-7 col-md-12 col-12">
                    <div class="hero-image wow fadeInRight" data-wow-delay=".4s">
                        <img src="assets/images/hero/gatita.jpg" alt="#">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2 col-md-12 col-12">
                    <div class="cta-content">
                        <h2 class="wow fadeInUp" data-wow-delay=".2s">You are using free Lite <br>Version of pink ink
                        </h2>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-12">
                        ...
                        <div class="single-footer f-about">
                            <div class="logo">
                                <a href="index.html">
                                    <img src="assets/images/logo/pink-ink.jpg" alt="#">
                                </a>
                            </div>
